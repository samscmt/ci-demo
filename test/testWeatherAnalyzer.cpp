...
public:
    explicit MockWeatherService(const WeatherData &mockData) : m_mockData(mockData) {
    }
...
TEST_CASE("WeatherAnalyzer correctly identifies good weather for outdoor activities",
          "[WeatherAnalyzer]") {
